...
if wget -q https://github.com/OFC-YOVANI/HADES-BOT-MD/media/"$lala.mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/OFC-YOVANI/HADES-BOT-MD\ncd HADES-BOT-MD\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Cementoenpolvo/CasinosDefinitivo.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} HADES-BOT-MD${b}: "
	read opcion
	case $opcion in
            01|1)
